        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    DefaultMonthlyRent = table.Column<decimal>(type: "decimal(10,2)", nullable: false),
                    DefaultWaterFee = table.Column<decimal>(type: "decimal(10,2)", nullable: false),
                    DefaultElectricityFee = table.Column<decimal>(type: "decimal(10,2)", nullable: false),
                    DefaultWifiFee = table.Column<decimal>(type: "decimal(10,2)", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    FloorId = table.Column<int>(type: "int", nullable: false),
                    CustomMonthlyRent = table.Column<decimal>(type: "decimal(18,2)", nullable: true),
                    CustomWaterFee = table.Column<decimal>(type: "decimal(18,2)", nullable: true),
                    CustomElectricityFee = table.Column<decimal>(type: "decimal(18,2)", nullable: true),
                    CustomWifiFee = table.Column<decimal>(type: "decimal(18,2)", nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    WifiFee = table.Column<decimal>(type: "decimal(18,2)", nullable: false),
                    ...
                    OtherFeesDescription = table.Column<string>(type: "nvarchar(200)", maxLength: 200, nullable: true),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Bills_AspNetUsers_TenantId",
                        column: x => x.TenantId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id");
                    table.ForeignKey(
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    RatePerKwh = table.Column<decimal>(type: "decimal(18,2)", nullable: false),
                    Notes = table.Column<string>(type: "nvarchar(500)", maxLength: 500, nullable: true),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_MeterReadings_AspNetUsers_TenantId",
                        column: x => x.TenantId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id");
                    table.ForeignKey(
                        name: "FK_MeterReadings_Bills_BillId",
                        column: x => x.BillId,
            ...
            migrationBuilder.CreateIndex(
                name: "IX_MeterReadings_TenantId",
                table: "MeterReadings",
                column: "TenantId");
